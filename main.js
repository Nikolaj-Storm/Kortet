...
function renderMarkers() {
	...
	for (var i in markers) {
		...
		if 
		(
			(placemark.marketValuation > 0 && showPublic)) {
...
function renderHeatMap() {
	...
	for (var i in markers) {
	  ...
	  if (placemark.latitude === null || placemark.longitude === null) {
		continue; // Skip placemarks with null latitude or longitude
	  }
  
	  var weight = 1; // Assigning a constant weight of 1 to all markers
